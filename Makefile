CC=emcc
CFLAGS= -pthread -sENVIRONMENT=web,worker -O3 -sUSE_PTHREADS=1 -ffast-math -sMAX_WEBGL_VERSION=2 -sMIN_WEBGL_VERSION=2 -sUSE_WEBGL2=1 -Wno-unused-result -sFORCE_FILESYSTEM=1 -lidbfs.js -sALLOW_MEMORY_GROWTH=1 -s TOTAL_MEMORY=1400mb \
